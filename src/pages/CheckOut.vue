		...
		<form @submit.prevent="Function.submitPayment">
			<div class="row w-75 m-0 mx-auto">
				<div class="col-12 col-lg-6 p-0 pe-1">
					<div class="mb-3">
						<input placeholder="Nome" type="text" v-model="Store.name_client" name="name_client" id="name_client" class="form-control" />
					</div>
					<div class="mb-3">
						<input
							placeholder="Email"
			...
			<div class="col-12 col-lg-auto">
				<div class="table-responsive">
					<table class="table">
						<thead>
							<tr>
								<th scope="col" class="p-0 px-2 pb-2">Immagine</th>
